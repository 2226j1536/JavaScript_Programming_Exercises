...
var getTotalBillV2 = function (itemCosts, itemCounts) {
    var total = 0;
...
console.log("The total cost is $" + getTotalBillV2(costs, numOfEach));
var items = [
...
var getTotalBillV3 = function (items) {
    var total = 0;
...
console.log("The total cost is $" + getTotalBillV3(items));
